	...
	return (
		...
		>
			...
			<div className="aspect-square rounded-xl bg-gray-100 relative">
				...
				/>
				<div className="opacity-0 group-hover:opacity-100 transition absolute w-full bottom-0">
					<div className="flex gap-x-6 place-items-center w-full bg-gray-100 bg-opacity-70 justify-center">
						<p>Quick shop</p>
						<IconButton
							onClick={onPreview}
							icon={<Expand size={16} className="text-gray-600" />}
						/>
						{/* <IconButton
							onClick={onAddToCart}
